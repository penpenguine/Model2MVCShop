...
<table width="100%" border="0" cellspacing="0" cellpadding="0"	style="margin-top: 13px;">
	...
	<tr>
		...
		<td class="ct_write01">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="105">
					${purchase.purchaseProd.getProdNo()}</td>
					<td></td>
				</tr>
			</table>
		</td>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">${purchase.buyer.getUserName() }</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
	...
	<tr>
		...
		<td class="ct_write01">
			<c:choose>
				<c:when test="${purchase.pruchaseOption.trim() eq '1'}">
						현금구매
				</c:when>
				<c:when test="${purchase.pruchaseOption.trim() eq '2'}">
						카드구매		
				</c:when>	
				<c:otherwise>
						기타구매
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">${purchase.dlyRequest}</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
